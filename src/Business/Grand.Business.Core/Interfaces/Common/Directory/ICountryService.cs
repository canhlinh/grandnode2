...
public interface ICountryService
{
    ...
    /// <returns>Countries</returns>
    Task<IList<Country>>
        GetAllCountriesForBilling(string languageId = "", string storeId = "", bool showHidden = false);
    ...
    /// <param name="showHidden">A value indicating whether to show hidden records</param>
    /// <returns>Countries</returns>
    Task<IList<Country>> GetAllCountriesForShipping(string languageId = "", string storeId = "",
