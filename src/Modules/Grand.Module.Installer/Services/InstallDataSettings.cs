...
public partial class InstallationService
{
    protected virtual async Task InstallSettings(bool installSampleData)
    {
        ...
        await _settingRepository.SaveSetting(new PdfSettings {
            LogoPictureId = "",
            InvoiceHeaderText = null,
            InvoiceFooterText = null
        });

        await _settingRepository.SaveSetting(new CommonSettings {
        ...
        await _settingRepository.SaveSetting(new SystemSettings {
            DeleteGuestTaskOlderThanMinutes = 1440
        });
        await _settingRepository.SaveSetting(new SecuritySettings {
            AdminAreaAllowedIpAddresses = null
        });
        await _settingRepository.SaveSetting(new MediaSettings {
        ...
        await _settingRepository.SaveSetting(new SeoSettings {
            PageTitleSeparator = ". ",
        ...
        await _settingRepository.SaveSetting(new AdminAreaSettings {
        ...
        await _settingRepository.SaveSetting(new CatalogSettings {
        ...
        await _settingRepository.SaveSetting(new CustomerSettings {
        ...
        await _settingRepository.SaveSetting(new AddressSettings {
            NameEnabled = false,
            CompanyEnabled = false,
        ...
        await _settingRepository.SaveSetting(new LoyaltyPointsSettings {
            Enabled = true,
            ExchangeRate = 1,
        ...
        await _settingRepository.SaveSetting(new ShoppingCartSettings {
        ...
        await _settingRepository.SaveSetting(new OrderSettings {
        ...
        await _settingRepository.SaveSetting(new ShippingSettings {
        ...
        await _settingRepository.SaveSetting(new ShippingProviderSettings {
            ActiveSystemNames = ["Shipping.FixedRate"]
        });

        await _settingRepository.SaveSetting(new PaymentSettings {
        ...
        await _settingRepository.SaveSetting(new TaxSettings {
        ...
        await _settingRepository.SaveSetting(new TaxProviderSettings {
            ActiveTaxProviderSystemName = "Tax.FixedRate"
        });

        await _settingRepository.SaveSetting(new DateTimeSettings {
            DefaultStoreTimeZoneId = ""
        });

        await _settingRepository.SaveSetting(new BlogSettings {
            Enabled = true,
            PostsPageSize = 10,
        ...
        await _settingRepository.SaveSetting(new PushNotificationsSettings {
            Enabled = false,
            AllowGuestNotifications = true
        });

        await _settingRepository.SaveSetting(new AdminSearchSettings {
            BlogsDisplayOrder = 0,
        ...
        await _settingRepository.SaveSetting(new NewsSettings {
            Enabled = true,
            AllowNotRegisteredUsersToLeaveComments = false,
        ...
        await _settingRepository.SaveSetting(new VendorSettings {
        ...
        await _settingRepository.SaveSetting(new EmailAccountSettings {
            DefaultEmailAccountId = eaGeneral.Id
        });

        await _settingRepository.SaveSetting(new WidgetSettings {
